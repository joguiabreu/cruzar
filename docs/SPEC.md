...
- AC9: The report contains Summary, Spending Detail, Investment Detail in order, plus an optional fourth section iff un-categorized merchants exist. Schemas/currencies as in Outputs.
